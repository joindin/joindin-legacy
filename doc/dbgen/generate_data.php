<?php
    ...
    $events = array();
    $events['first'] = array("PHP", "Perl", "Python", "Ruby", "C", "MySQL", "DevOp", "Linux", "Debian", "CentOS", "Zend", "Developer", "Web", "Symfony", "Apache", "Computer", "IT", "Dev");
    $events['last']  = array("Con", "Conf", " meetup", "UUG", " day", "Congress");


    // Words to generate talk titles for your future presentations...
    $talk_generator_data = array(
        "a" => array("Coaching", "Dealing with", "Producing", "Maintaining", "Controlling", "Creating", "Having", "Assembling", "Monitoring", "Accessing", "Generating", "Refactoring"),
        "b" => array("heavy", "light", "fast", "optimal", "flexible", "rigid", "technical", "oldschool", "newtech", "fantastic", "obsolete", "second generation", "v2.0", "private", "public"),
        "c" => array("systems", "operations", "products", "entities", "design patterns", "clouds"),
        "d" => array("in", "through", "with", "near", "because of", "instead of", "together with", "under"),
        "e" => array("Python", "Perl", "Ruby", "C", "Memcached", "NoSQL", "CouchDB", "MongoDB", "MySQL", "Oracle", "PostgresSQL", "PHP", "Linux", "Shell scripting", "Hadoop", "Apache", "Varnish"),
    );
    ...
    $event_comments['source'] = array("web", "web", "web", "api", "api", "iphone", "android");

    // List of track colors
    $track_colors = array("red", "green", "blue", "black", "yellow", "white", "cyan", "gray");
