...
<div class="box">
	...
	foreach($attend_list as $attendee){
		...
		if(is_file($icon_file)){
			$has_icons=true;
			echo '<a href="/user/view/'.$attendee->ID.'"><img src="/inc/img/user_gravatar/user'.$attendee->ID.'.jpg" height="20" style="margin:2px"i alt="'.$attendee->full_name.'" title="'.$attendee->full_name.'"/></a>';
		}
	}
