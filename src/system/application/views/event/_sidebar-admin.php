...
<div class="box">
	...
	<div class="ctn">
		...
		<li><a href="/event/claim/<?php echo $eid; ?>">Pending Talk Claims</a> (<?php echo $talk_claim_count; ?>)
        <li><a href="/event/claims/<?php echo $eid; ?>">Pending Admin Claims</a> (<?php echo $admin_claim_count; ?>)
