...
<body>
	<a class="talk_title" href="#" onClick="goTo('http://<?php echo $site ?>/talk/view/<?php echo $talk->ID; ?>')"><?php echo $talk->talk_title; ?></a><br/>
	<?php foreach($talk->speaker as $speaker){ echo $speaker->speaker_name.' '; } ?> @ 
	<a href="#" onClick="goTo('http://<?php echo $site ?>/event/view/<?php echo $talk->event_id; ?>')"><?php echo $talk->event_name; ?></a>
