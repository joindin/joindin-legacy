...
<p>We have two APIs - an older one and a new <b>RESTful API</b> as well.  If you want to use the data from joind.in elsewhere, then take a look at the <a href="/api">API Documentation</a>.</p>
