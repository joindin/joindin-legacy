...
class User extends MY_Controller
{
    ...
    function login()
    {
        ...
        $rules = array(
            ...
            'pass', 'Password','required|callback_start_up_check'
        );
    ...
    function forgot($id = null, $request_code = null)
    {
        ...
        $rules = array(
            'user','Username','required|trim|xss_clean',
            'email','Email Address','required|trim|xss_clean|valid_email'
        );
        $this->form_validation->set_rules($rules);
    ...
    function register()
    {
        ...
        $rules = array(
            ...
            'pass','Password','required|trim|matches[passc]|md5',
            'passc','Confirm Password','required|trim',
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->user_model->createUser($arr);
    ...
    function manage()
    {
        ...
        $rules = array(
            ...
            'pass','Password','trim|matches[pass_conf]|md5',
            'pass_conf','Confirm Password','trim',
        );
        $this->form_validation->set_rules($rules);
        ...
        if ($this->form_validation->run() != false) {
            ...
            if (!empty($pass)) {
                $data['password'] = $this->form_validation->pass;
            }
    ...
    function admin($page = null)
    {
        ...
        $rules = array(
            'user_search','Search Term','required'
        );
        $this->form_validation->set_rules($rules);
    ...
    function usern_check($str)
    {
        ...
        if (!empty($ret)) {
            $this->form_validation->_error_messages['usern_check']
    ...
    function email_exist_check($str)
    {
        ...
        if (empty($ret)) {
            $this->form_validation->_error_messages['email_exist_check']
    ...
    function login_exist_check($str)
    {
        ...
        if (empty($ret)) {
            $this->form_validation->_error_messages['login_exist_check']
                = 'Invalid username!';
            return false;
        }
    ...
    function user_email_match_check($str)
    {
        ...
        if (empty($ret)) {
            $this->form_validation->_error_messages['user_email_match_check']
