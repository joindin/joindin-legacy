...
class Theme extends MY_Controller
{
    ...
    public function add($id = null)
    {
        ...
        $rules = array(
            'theme_name','Theme Name','required',
            'theme_event','Theme Event','required',
            'theme_desc','Theme Description','required'
        );
        ...
        if ($this->form_validation->run() != false) {
            ...
            if (!$this->upload->do_upload('theme_style')) {
                $this->form_validation->error_string = $this->upload->display_errors();
            } else {
                ...
                if (!empty($msg)) {
                    $this->form_validation->error_string = implode("<br/>", $msg);
                }
            }
        }
