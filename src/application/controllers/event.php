...
class Event extends MY_Controller
{
    ...
    function add($id = null)
    {
        ...
        $rules = array(
            ...
            'event_loc','Event Location','required',
        ...
        if ($this->form_validation->run() == false) {
            if ($id) {
				...
				$this->form_validation->event_cfp_start 	= $event_detail[0]->event_cfp_start;
				$this->form_validation->event_cfp_end 	= $event_detail[0]->event_cfp_end;
				$this->form_validation->event_cfp_url 	= $event_detail[0]->event_cfp_url;

                foreach ($event_detail[0] as $k => $v) {
                    if ($k == 'event_start') {
                        $this->form_validation->start_mo = $this->timezone
                        ...
                        $this->form_validation->start_day = $this->timezone
                            ->formattedEventDatetimeFromUnixtime(
                                $v,
                                $event_detail[0]->event_tz_cont . '/' .
                                $event_detail[0]->event_tz_place,
                        ...
                        $this->form_validation->start_yr = $this->timezone
                            ->formattedEventDatetimeFromUnixtime(
                                $v,
                                $event_detail[0]->event_tz_cont . '/' .
                                $event_detail[0]->event_tz_place,
                        ...
                        $this->form_validation->end_mo = $this->timezone
                            ->formattedEventDatetimeFromUnixtime(
                                $v,
                                $event_detail[0]->event_tz_cont . '/' .
                                $event_detail[0]->event_tz_place,
                        ...
                        $this->form_validation->end_day = $this->timezone
                            ->formattedEventDatetimeFromUnixtime(
                                $v,
                                $event_detail[0]->event_tz_cont . '/' .
                                $event_detail[0]->event_tz_place,
                        ...
                        $this->form_validation->end_yr = $this->timezone
                            ->formattedEventDatetimeFromUnixtime(
                                $v,
                                $event_detail[0]->event_tz_cont . '/' .
                                $event_detail[0]->event_tz_place,
                        ...
                        $this->form_validation->$k = $v;
                    }
                }
                $this->form_validation->event_private = $event_detail[0]->private;
				$this->form_validation->cfp_checked = ($event_detail[0]->event_cfp_start!=null && $event_detail[0]->event_cfp_end!=null) ? true : false;
				
				if($this->input->post('is_cfp')==null && $id == null){
					$this->form_validation->event_cfp_start 	= time();
					$this->form_validation->event_cfp_end 	= time();
					
				}elseif($this->input->post('is_cfp')=='1'){
					$this->form_validation->cfp_checked 		= true;
					$this->form_validation->event_cfp_end 	= mktime(
						0,0,0,
						$this->input->post('cfp_end_mo'),
						$this->input->post('cfp_end_day'),
						$this->input->post('cfp_end_yr')
					);
					$this->form_validation->event_cfp_start 	= mktime(
						0,0,0,
			...
			if($is_cfp){
				...
				$this->form_validation->cfp_checked		= true;
				$this->form_validation->event_cfp_end 	= $arr['event_cfp_end'];
				$this->form_validation->event_cfp_start 	= $arr['event_cfp_start'];
				$this->form_validation->event_cfp_url 	= $this->input->post('cfp_url');
			}else{
    ...
    function view($id, $opt = null, $opt_id = null)
    {
        ...
        $rules = array(
            'event_comment','Event Comment','required'
        );
        $this->form_validation->set_rules($rules);
...
//        $this->form_validation->set_fields($fields);
        ...
        if (empty($this->form_validation->start_mo)) {
            $sel_fields = array(
                'start_mo'      => 'm',
                'start_day'     => 'd',
                'start_yr'      => 'Y',
            ...
            foreach ($sel_fields as $k => $v) {
                $this->form_validation->$k = date($v);
            }
            $this->form_validation->cfp_checked = false;
            $this->form_validation->is_private = 'n';
        } else {
            $this->form_validation->cfp_checked = $this->form_validation->is_cfp;
        }
        ...
        if ($this->form_validation->run() != false) {
            ...
            $this->form_validation->is_admin = 0;
        }
    ...
    function start_mo_check()
    {
        ...
        $t = mktime(
            0, 0, 0,
            $this->form_validation->start_mo,
            $this->form_validation->start_day,
            $this->form_validation->start_yr
        );
        $e = mktime(
            0, 0, 0,
            $this->form_validation->end_mo,
            $this->form_validation->end_day,
            $this->form_validation->end_yr
        );
    ...
    function cfp_start_mo_check()
    {
        $cfp_st = mktime(
            0, 0, 0,
            $this->form_validation->cfp_start_mo,
            $this->form_validation->cfp_start_day,
            $this->form_validation->cfp_start_yr
        );
        $cfp_end = mktime(
            0, 0, 0,
            $this->form_validation->cfp_end_mo,
            $this->form_validation->cfp_end_day,
            $this->form_validation->cfp_end_yr
        );
        $evt_st = mktime(
            0, 0, 0,
            $this->form_validation->start_mo,
    ...
    {
        $chk_str = str_replace('_', '_chk_', $this->form_validation->_current_field);
        $val     = $this->input->post($chk_str);

        if (($val == 1) && !$this->form_validation->valid_email($str)) {
            $this->form_validation->set_message(
    ...
    {
        if (! preg_match("|^https?://|", $this->form_validation->cfp_url)) {
            $this->form_validation->set_message(
                'cfp_url_check',
