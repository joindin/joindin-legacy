...
<div class="box">
    ...
    <div class="row">
    	...
    	<?php echo form_input(array('name' => 'event_title', 'id' => 'event_title'), $this->input->post('event_title')); ?>
	...
	<div class="row">
    	...
    	<?php echo form_input(array('name' => 'event_loc', 'id' => 'event_location'), $this->input->post('event_loc')); ?>
	...
	<div class="row">
		...
		<table>
			<tr>
				<td>
					<input type="text" name="addr" id="addr" value="<?php echo $this->input->post('addr'); ?>" />
				</td>
				<td>
		...
		<table>
			<tr>
				<td>
					Latitude:  <input type="text" name="event_lat" id="event_lat" style="width:200px;" value="<?php echo $this->input->post('event_lat'); ?>" />
				</td>
				<td>
					Longitude: <input type="text" name="event_long" id="event_long" style="width:200px;" value="<?php echo $this->input->post('event_long'); ?>"/>
				</td>
			</tr>
		</table>
		<table>
    ...
    <div class="row">
    	...
    	<?php echo form_input(array('name' => 'event_contact_name', 'id' => 'event_contact_name'), $this->input->post('event_contact_name')); ?>
    ...
    <div class="row">
    	...
    	<?php echo form_input(array('name' => 'event_contact_email', 'id' => 'event_contact_email'), $this->input->post('event_contact_email')); ?>
	...
	<div class="row">
    	...
    	<?php echo form_input(array('name' => 'event_stub', 'id' => 'event_stub'), $this->input->post('event_stub')); ?>
        <div class="clear"></div>
    </div>
	...
	<div class="row">
		...
		<?php 
			$is_admin=(isset($this->form_validation->is_admin)) ? $this->input->post('is_admin') : '';
    ...
    <div class="row">
		...
		echo form_dropdown('start_mo',$start_mo,$this->input->post('start_mo'));
		echo form_dropdown('start_day',$start_day,$this->input->post('start_day'));
		echo form_dropdown('start_yr',$start_yr,$this->input->post('start_yr'));
 ...
 <div class="row">
	...
	<?php
		...
		echo form_dropdown('end_mo',$start_mo,$this->input->post('end_mo'));
		echo form_dropdown('end_day',$start_day,$this->input->post('end_day'));
		echo form_dropdown('end_yr',$start_yr,$this->input->post('end_yr'));
 ...
 <div class="row">
	...
	<div class="row">
		...
		<?php
		$is_priv=(isset($this->form_validation->is_private)) ? $this->input->post('is_private') : '';
	...
	<?php
		...
		$js=($this->form_validation->cfp_checked==1) ? '' : 'disabled';
		
		echo form_dropdown('cfp_start_mo',$cfp_start_mo,$this->input->post('cfp_start_mo'),'id="cfp_start_mo" '.$js);
		echo form_dropdown('cfp_start_day',$cfp_start_day,$this->input->post('cfp_start_day'),'id="cfp_start_day" '.$js);
		echo form_dropdown('cfp_start_yr',$cfp_start_yr,$this->input->post('cfp_start_yr'),'id="cfp_start_yr" '.$js);
 ...
 <div class="row">
	...
	<?php
		...
		echo form_dropdown('cfp_end_mo',$cfp_end_mo,$this->input->post('cfp_end_mo'),'id="cfp_end_mo" '.$js);
		echo form_dropdown('cfp_end_day',$cfp_end_day,$this->input->post('cfp_end_day'),'id="cfp_end_day" '.$js);
		echo form_dropdown('cfp_end_yr',$cfp_end_yr,$this->input->post('cfp_end_yr'),'id="cfp_end_yr" '.$js);
