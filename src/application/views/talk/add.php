...
<div id="box">
	...
	<?php echo form_input('talk_title',$this->input->post('talk_title'));?>
	<div class="clear"></div>
    </div>
    <div class="row">
	...
	if (isset($_POST['speaker']) && count($this->input->post('speaker')) != 0) {
		foreach($this->input->post('speaker') as $speakerId => $speaker){
	...
	echo form_dropdown('given_hour', $given_hour, $this->input->post('given_hour'));
	echo form_dropdown('given_min', $given_min, $this->input->post('given_min'));
	?>
	<div class="clear"></div>
    </div>
    <div class="row">
	...
	<?php
		...
		}else{ $sessionType=$this->input->post('session_type'); }
	...
	<?php
		...
		}else{ $slang = $this->input->post('session_lang'); }
	...
	$arr=array(
		'name'=>'talk_desc',
		'value'=>$this->input->post('talk_desc'),
		'cols'=>40,
		'rows'=>10
	);
	...
	<td><?php echo form_input('slides_link',$this->input->post('slides_link')); ?></td>
	<div class="clear"></div>
    </div>
    <div class="row">
