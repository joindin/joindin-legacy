...
<tr>
	...
	echo form_dropdown('post_mo',$post_mo,$this->input->post('post_mo)'));
	echo form_dropdown('post_day',$post_day,$this->input->post('post_day'));
	echo form_dropdown('post_yr',$post_yr,$this->input->post('post_yr'));
	echo '&nbsp;@&nbsp;';
	echo form_dropdown('post_hr',$post_hr,$this->input->post('post_hr'));
	echo form_dropdown('post_mi',$post_mi,$this->input->post('post_mi'));
	?>
	</td>
</tr>
<tr>
	...
	echo form_dropdown('category',$cat_list,$this->input->post('category'));
	?>
	</td>
</tr>
