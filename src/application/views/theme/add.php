...
<div id="box">
	...
	<?php echo form_input('theme_name',$this->input->post('theme_name'));?>
	<div class="clear"></div>
    </div>

	<div class="row">
	<label for="theme_title">Theme for Event:</label>
	<?php echo form_dropdown('theme_event',$this->user_events,$this->input->post('theme_event')); ?>
	<div class="clear"></div>
    </div>
	...
	<?php 
		$arr=array(
			'name'	=> 'theme_desc',
			'id'	=> 'theme_desc',
			'value'	=> $this->input->post('theme_desc'),
			'cols'	=> 50,
			'rows'	=> 10
		);
