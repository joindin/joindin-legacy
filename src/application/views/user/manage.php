...
<div class="box">
    ...
    <div class="row">
    	...
    	<?php echo form_input(array('name' => 'full_name', 'id' => 'full_name', 'value' => $curr_data[0]->full_name), $this->input->post('full_name')); ?>
    ...
    <div class="row">
    	...
    	<?php echo form_input(array('name' => 'email', 'id' => 'email', 'value' => $curr_data[0]->email), $this->input->post('email')); ?>
    ...
    <div class="row">
    	...
    	<?php echo form_input(array('name' => 'twitter_username', 'id' => 'twitter_username', 'value' => $curr_data[0]->twitter_username), $this->input->post('twitter_username')); ?>
