-- -------------------------------------------------------------------------- --
-- Holds default data for the joind.in application
-- @since Orange (V3)
...
INSERT INTO `messaging_service_providers` (`id`, `name`) VALUES
(1, 'AIM'),
(2, 'Google Talk'),
(3, 'ICQ'),
(4, 'IRC'),
...
-- Session Categories ------------------------------------------------------- --
INSERT INTO `session_categories` (`id`, `title`, `description`) VALUES 
(1, 'Talk', 'Talk'),
(2, 'Social Event', 'Social Event'),
(3, 'Keynote', 'Keynote'),
(4, 'Workshop', 'Workshop');

-- Web Service Providers ---------------------------------------------------- --
INSERT INTO `web_service_providers` (`id`, `name`) VALUES
(1, 'Flickr'),
(2, 'Picasa Web Albums'),
(4, 'delicious'),
(5, 'StumbleUpon'),
